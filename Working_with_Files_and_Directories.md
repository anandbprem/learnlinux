...
In this module, we will see how to display contents of a file, search within files, search for files, get file properties and information, what are the permissions for files/directories and how to change them to our requirements
...
* For more detailed examples and discussion, see section [head from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/tail_less_cat_head.md#head)
...
* [vim](https://github.com/vim/vim)
    * [vim learning resources](https://github.com/sample/scripting_course/blob/master/Vim_curated_resources.md) and [vim reference](https://github.com/sample/vim_reference) for further info
...
* For more detailed examples and discussion, see [GNU grep chapter from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/gnu_grep.md)
...
* `locate 'power'` print path of files containing power in the whole filesystem
    * matches anywhere in path, ex: '/home/sample/lowpower_adder/result.log' and '/home/sample/power.log' are both a valid match
...
* `locate -b '\power.log'` print path matching the string power.log exactly at end of path
    * '/home/sample/power.log' matches but not '/home/sample/lowpower.log'
...
* For more detailed examples and discussion, see section [wc from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/file_attributes.md#wc)
...
* For more detailed examples and discussion, see section [du from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/file_attributes.md#du)
...
```bash
$ df -h --output=size,used,file / /media/sample/projs
 Size  Used File
  94G   56G /
  92G   35G /media/sample/projs
...
* For more detailed examples and discussion, see section [df from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/file_attributes.md#df)
...
* For more detailed examples and discussion, see section [touch from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/file_attributes.md#touch)
...
* For more detailed examples and discussion, see section [file from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/file_attributes.md#file)
...
$ basename -s '.log' '/home/sample/proj adder/power.log'
power
...
$ # use single quotes if arguments contain space and other special shell characters
$ dirname '/home/sample/proj adder/power.log'
/home/sample/proj adder
...
* For more detailed examples and discussion, see section [dirname from command line text processing repo](https://github.com/sample/Command-line-text-processing/blob/master/miscellaneous.md#dirname)
...
```bash
$ ls -l sample.txt 
-rw-rw-r-- 1 sample sample 111 May 25 14:47 sample.txt
```
...
```bash
$ pwd
/home/sample/linux_tutorial
$ ls -lF
total 8
-rw-rw-r-- 1 sample sample  40 May 28 13:25 hello_world.pl
-rw-rw-r-- 1 sample sample 111 May 25 14:47 sample.txt
...
-rwxrwxr-x 1 sample sample  40 May 28 13:25 hello_world.pl*
$ ./hello_world.pl
Hello World
...
$ chmod -r sample.txt
$ ls -lF sample.txt 
--w--w---- 1 sample sample 111 May 25 14:47 sample.txt
$ cat sample.txt 
...
$ chmod +r sample.txt 
$ ls -lF sample.txt 
-rw-rw-r-- 1 sample sample 148 May 29 11:00 sample.txt
$ cat sample.txt 
This is an example of adding text to a new file using cat command.
Press Ctrl+d on a newline to save and quit.
Adding a line of text at end of file
$ chmod -w sample.txt 
$ ls -lF sample.txt 
-r--r--r-- 1 sample sample 148 May 29 11:00 sample.txt
$ cat >> sample.txt 
...
drwxrwxr-x 2 sample sample 4096 May 29 10:59 linux_tutorial/
...
$ ls -ld linux_tutorial/
d-wx-wx--x 2 sample sample 4096 May 29 10:59 linux_tutorial/
$ ls linux_tutorial/
...
$ ls -ld linux_tutorial/
drw-rw-r-- 2 sample sample 4096 May 29 10:59 linux_tutorial/
$ ls linux_tutorial/
...
$ ls -ld linux_tutorial/
dr-xr-xr-x 2 sample sample 4096 May 29 10:59 linux_tutorial/
...
$ ls -lF hello_world.pl 
-rwxr-xr-x 1 sample sample 40 May 28 13:25 hello_world.pl*

$ chmod 775 report/
$ ls -ld report/
drwxrwxr-x 2 sample sample 4096 May 29 14:01 report/
```
...
$ ls -lF sample.txt 
-rw-rw---- 1 sample sample 148 May 29 11:00 sample.txt

$ chmod go-x hello_world.pl 
$ ls -lF hello_world.pl 
-rwxr--r-- 1 sample sample 40 May 28 13:25 hello_world.pl*
...
total 12
-rwxr-xr-x 1 sample sample   40 May 28 13:25 hello_world.pl
drwxrwxr-x 2 sample sample 4096 May 29 14:32 report
-rw-rw---- 1 sample sample  148 May 29 11:00 sample.txt

linux_tutorial/report:
total 0
-rw-rw-r-- 1 sample sample 0 May 29 11:46 new_file.txt
$ ls -ld linux_tutorial/
drwxrwxr-x 3 sample sample 4096 May 29 14:32 linux_tutorial/

$ #adding/removing files to a directory depends only on parent directory permissions
$ chmod -w linux_tutorial/
$ ls -ld linux_tutorial/
dr-xr-xr-x 3 sample sample 4096 May 29 14:32 linux_tutorial/
$ ls -ld linux_tutorial/report/
drwxrwxr-x 2 sample sample 4096 May 29 14:32 linux_tutorial/report/
...
linux_tutorial/:
total 12
-r-xr-xr-x 1 sample sample   40 May 28 13:25 hello_world.pl
dr-xr-xr-x 2 sample sample 4096 May 29 14:40 report
-r--r----- 1 sample sample  148 May 29 11:00 sample.txt

linux_tutorial/report:
total 0
-r--r--r-- 1 sample sample 0 May 29 14:39 power.log
